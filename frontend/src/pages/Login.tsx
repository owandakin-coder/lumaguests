  ...
  return (
    <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
      ...
      <div className="text-center mb-8">
        ...
        <h1 className="text-[32px] font-bold text-charcoal-900">Luma Guests</h1>
        <p className="text-sm text-charcoal-400 mt-1">כניסה לחשבון שלך</p>
      </div>
      ...
      <p className="text-center text-sm text-charcoal-500">
        אין לך חשבון עדיין?{' '}
        <button onClick={onSwitchToRegister} className="text-gold-600 font-semibold">
          הרשמה
        </button>
      </p>
    </motion.div>
